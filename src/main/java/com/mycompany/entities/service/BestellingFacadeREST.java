...
import com.mycompany.entities.entities.Bestelling;
 ...
 */
@Stateless
@Path("com.mycompany.proberen.bestelling")
public class BestellingFacadeREST extends AbstractFacade<Bestelling> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Bestelling entity) {
        super.edit(entity);
    }
    ...
    public Bestelling find(@PathParam("id") Long id) {
